...
class ScatterSearch(Algorithm):
    ...
    def _initialize(self):
        ...
        self.solution_pool = self.diversification_method.do(self.problem, self.solution_pool_size)
        
        #Improvement Method
        self.solution_pool = self.initial_improvement_method.improve_pool(self.solution_pool)
        
        #Reference Set Creation
        self.reference_set = self.ReferenceSet.create(self.solution_pool, self.reference_set_size, diversity_threshold=self.diversity_threshold)
    ...
    def _advance(self, **kwargs):
        ...
        # Apply combination method to generated pairs
